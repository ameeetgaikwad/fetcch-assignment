...
function Payment() {
  ...
  return (
    <>
      <div className="flex flex-col h-[96%] w-[97%] sm:w-[97%] md:w-[85%] bg-white mx-[12px] mt-[12px] mb-[32px] border-2 rounded-[20px] border-[#EBEBEB] overflow-x-hidden">
        ...
        <div className={`m-8 flex flex-row justify-center gap-x-4`}>
          <div className="flex flex-col gap-y-5">
            <div className="flex flex-col gap-y-4 items-center sm:items-start">
              <div>
                <p className="font-semibold text-2xl h-[29px] flex flex-row justify-center sm:justify-start">
                  Choose Link Type
                </p>
              </div>
